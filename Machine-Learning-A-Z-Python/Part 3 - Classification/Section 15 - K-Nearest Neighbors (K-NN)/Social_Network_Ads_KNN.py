...
dataset = pd.read_csv('C:\\Users\\nikhilc\\Google Drive\\_Data Science\\Udmey_A2Z_ML\\Machine Learning A-Z\\Part 3 - Classification\\Section 15 - K-Nearest Neighbors (K-NN)\\K_Nearest_Neighbors\\Social_Network_Ads.csv')
